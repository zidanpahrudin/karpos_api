...
function delayLog(item, timeout) {
    return new Promise((resolve) => {
        ...
        if (validateIndonesianPhoneNumber(item.phone_1)) {
            let valid_format_phone = "";
            let phone_number = item.phone_1;
            ...
            setTimeout(() => {
                ...
                function formatTanggal(tanggal) {
                    ...
                    // return tanggal.toString().substring(11,8)+"-"+tanggal.toString().substring(5,7)+"-"+tanggal.toString().substring(0,4);
                }
                ...
                let data = JSON.stringify({
                    "jid": item.nomor + "@s.whatsapp.net",  // "jid": "628950xxxxx-1631xxxx@g.us", //item.nomor //"6287781382993"+"@s.whatsapp.net"
                    "type": "number",
                    "message": {
